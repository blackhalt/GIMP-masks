...
(define (script-fu-luminosity-masks image layer 
	...
	(gimp-desaturate-full copied-layer DESATURATE-LUMINOSITY) ;{ DESATURATE-LIGHTNESS (0), DESATURATE-LUMINOSITY (1), DESATURATE-AVERAGE (2) }
	...
	(set! new-mask (car (gimp-layer-create-mask L-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask LL-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask LLL-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask D-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask DD-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask DDD-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask M-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask MM-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
	...
	(set! new-mask (car (gimp-layer-create-mask MMM-layer ADD-CHANNEL-MASK))) ;creates the mask before adding it
...
(script-fu-register
  "script-fu-luminosity-masks"         ;function name
  "<Image>/Filters/Luminosity Masks"    ;menu register
  "Generates 9 layers with different luminosity masks."       ;description
